...
namespace Tool.SceneLoadMag
{
    ...
    public class SceneLoadManager : Singleton<SceneLoadManager>
    {
        ...
        public void AsyncLoadScene(string sceneName, float bufferBlackUITime = 0, float waitTime = 0, Action callBack = null,CanvasGroup canvasGroup = null) =>
            PublicMonoKit.Instance.GetPublicMono().StartCoroutine(IAsyncLoadScene(sceneName, bufferBlackUITime, waitTime, callBack,canvasGroup));
